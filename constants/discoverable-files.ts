/**
 * Discoverable Files Constants
 *
 * This file contains all the file and directory paths that Dotport can discover
 * and back up. Contributors can easily add new files to these lists.
 *
 * Format for each entry:
 * { path: '~/path/to/file', name: 'Display Name' }
 */
